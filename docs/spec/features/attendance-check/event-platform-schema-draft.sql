...
COMMENT ON COLUMN event.event_round_prize_probability.weight IS '가중치 (기본값 1)';
...
COMMENT ON COLUMN event.event_win.event_round_prize_id IS '로컬 보상 확정 경품 식별자 (SoT)';
...
-- Note: 참조 정합성은 FK 대신 Service 검증으로 보완한다.
-- ============================================================
